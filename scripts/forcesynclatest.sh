...
forcesync() {
  ...
  blockhash=`curl -s https://explorer.absolutecoin.net/api/getblockhash?height=$blockcount`
  echo "| ଓ hash : $blockhash"
  curl -s https://explorer.absolutecoin.net/block/$blockhash > /dev/null
  echo "╘═══════════════════════════════>>"
}
...
main() {
  ...
  currentblockcount=`curl -s https://explorer.absolutecoin.net/api/getblockcount`
